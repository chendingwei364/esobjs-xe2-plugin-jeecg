...
export declare class ESDoubleArrow extends ESGeoVector {
...
export declare namespace ESDoubleArrow {
...
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof ESDoubleArrow.createDefaultProps> & {
    type: string;
}>;
export {};

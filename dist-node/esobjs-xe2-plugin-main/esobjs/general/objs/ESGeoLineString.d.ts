...
export declare class ESGeoLineString extends ESGeoVector {
    ...
    private _distance;
    get distance(): number;
    get distanceChanged(): import("xbsj-xe2/dist-node/xe2-base-utils").Listener<[number, number]>;
    static defaults: {
...
export interface ESGeoLineString extends ReactivePropsToNativePropsAndChanged<ReturnType<typeof ESGeoLineString.createDefaultProps>> {
}
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof ESGeoLineString.createDefaultProps> & {
    type: string;
}>;
export {};

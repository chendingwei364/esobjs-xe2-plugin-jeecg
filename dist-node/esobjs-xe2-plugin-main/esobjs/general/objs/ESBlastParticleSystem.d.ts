...
export declare class ESBlastParticleSystem extends ESObjectWithLocation {
    ...
    get defaultProps(): {
        ...
        translation: import("xbsj-xe2/dist-node/xe2-base-utils").ReactiveVariable<[number, number, number]>;
        show: boolean;
        collision: boolean;
...
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof ESBlastParticleSystem.createDefaultProps> & {
    type: string;
}>;
export {};

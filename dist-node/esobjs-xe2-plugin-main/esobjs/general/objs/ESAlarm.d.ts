...
export declare class ESAlarm extends ESObjectWithLocation {
    ...
    get isFlyInCreatedChanged(): import("xbsj-xe2/dist-node/xe2-base-utils").Listener<[boolean, boolean]>;
    static defaults: {
...
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof ESAlarm.createDefaultProps> & {
    type: string;
}>;
export {};

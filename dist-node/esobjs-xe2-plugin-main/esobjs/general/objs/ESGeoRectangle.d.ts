...
export declare class ESGeoRectangle extends ESGeoVector {
    ...
    toPolygon(): [number, number, number][] | undefined;
...
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof ESGeoRectangle.createDefaultProps> & {
    type: string;
}>;
export {};

...
export declare class ESDiagonalArrow extends ESGeoVector {
...
export declare namespace ESDiagonalArrow {
...
export interface ESDiagonalArrow extends ReactivePropsToNativePropsAndChanged<ReturnType<typeof ESDiagonalArrow.createDefaultProps>> {
}
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof ESDiagonalArrow.createDefaultProps> & {
    type: string;
}>;
export {};

import { NumberProperty, Number2Property, BooleanProperty } from "xbsj-xe2/dist-node/xe2-base-objects";
...
export declare class ESLocalCircle extends ESLocalVector2D {
    ...
    getESProperties(): {
        ...
        location: never[];
        coordinate: (BooleanProperty | NumberProperty | Number2Property)[];
...
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof ESLocalCircle.createDefaultProps> & {
    type: string;
}>;
export {};

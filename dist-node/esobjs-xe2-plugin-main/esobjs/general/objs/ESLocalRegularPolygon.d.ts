...
export declare class ESLocalRegularPolygon extends ESLocalVector2D {
...
export declare namespace ESLocalRegularPolygon {
...
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof ESLocalRegularPolygon.createDefaultProps> & {
    type: string;
}>;
export {};

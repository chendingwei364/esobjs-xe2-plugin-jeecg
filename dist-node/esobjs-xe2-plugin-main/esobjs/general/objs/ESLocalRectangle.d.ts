...
export interface ESLocalRectangle extends ReactivePropsToNativePropsAndChanged<ReturnType<typeof ESLocalRectangle.createDefaultProps>> {
}
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof ESLocalRectangle.createDefaultProps> & {
    type: string;
}>;
export {};

...
function setupXe2() {
    ...
    do {
        ...
        if (xe2Debug.debugXe2) {
            ...
            scriptListStr += `<script src="js/xbsj-xe2/dist-web/xe2-all-in-one.js"><\/script>\n`;
        }

        scriptListStr += `<script src="js/xbsj-xe2-assets/dist-web/xe2-assets.js"><\/script>\n`;
        scriptListStr += `<script src="js/vue-xe2-plugin/dist-web/vue-xe2-plugin.js"><\/script>\n`;

        if (xe2Debug.debugSmplotting) {
            scriptListStr += `<script src="http://localhost:8194/smplotting-xe2-plugin.js"><\/script>\n`
        } else {
            scriptListStr += `<script src="js/smplotting-xe2-plugin/dist-web/smplotting-xe2-plugin.js"><\/script>\n`;
        }

        scriptListStr += `<script src="js/esobjs-xe2-plugin-assets/dist-web/esobjs-xe2-plugin-assets.js"><\/script>\n`;
        if (xe2Debug.debugEsobjs) {
            scriptListStr += `<script src="http://localhost:8195/esobjs-xe2-plugin.js"><\/script>\n`
        } else {
            scriptListStr += `<script src="js/esobjs-xe2-plugin/dist-web/esobjs-xe2-plugin.js"><\/script>\n`
        }
    ...
    if (useDefault) {
        ...
        <script src="/js/smplotting-xe2-plugin/dist-web/smplotting-xe2-plugin.js"><\/script>
...
class DebugInfoUI {
    constructor() {
        ...
        `
        add.onclick = () => {
            const JSPath = prompt("JS文件路径", "http://www.earthsdk.com/xxx.js");
            if (!JSPath) return;
            const paths = [...xe2Debug.extJsPaths]

...
export declare class FlvJsLoading extends Destroyable {
    static path: string;
    private _loading;
    get loading(): boolean;
    ...
    constructor();
    static _instance: FlvJsLoading | undefined;
    static instance(): FlvJsLoading;
}
...
declare class FlvVideoDom extends Destroyable {
    private _complexImage;
    private _videoSrc;
    get videoSrc(): string;
    private _videoDom;
...
export declare class FlvProcessing extends Destroyable {
    private _complexImage;
    private _imageUri;
    private _videoDom;
    get videoDom(): FlvVideoDom;

import { DebouncingDeprecated } from '../ProcessingObjsDeprecated/Debouncing';
 ...
 */
export declare class PointerClickDeprecated extends Destroyable {
    ...
    _debouncing: DebouncingDeprecated<[number, number, PointerEvent]>;

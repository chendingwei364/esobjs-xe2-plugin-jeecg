 ...
 * @deprecated
 */
export declare type StartProcessingFuncTypeDeprecated<CompleteValueType, ProgressValueType, StartValueType extends any[]> = (options: {
 ...
 * @deprecated
 */
export declare class ProcessingDeprecated<CompleteValueType = void, ProgressValueType = void, StartValueType extends any[] = []> extends Destroyable {
     ...
     */
    constructor(_startProcessingFunc: StartProcessingFuncTypeDeprecated<CompleteValueType, ProgressValueType, StartValueType>, startFunc?: ((...args: StartValueType) => void) | undefined, // 启动

...
export declare namespace ViewMatrix {
     ...
     */
    function computeView(position: Readonly<Number3>, direction: Readonly<Number3>, up: Readonly<Number3>, right: Readonly<Number3>, target?: Number16): Number16;
    function fromRotationMatrix3AndPosition(position: Readonly<Number3>, rotationMatrix3: Readonly<Number9>, target?: Number16): Number16;
    function fromRotationQuatAndPosition(position: Readonly<Number3>, rotationQuat: Readonly<Number4>, target?: Number16): Number16;
    /**
     * Computes a Matrix4 instance that transforms from world space to view space.
     *
     ...
     * @returns {Matrix4} The modified result parameter.
     */
    function lookAt(eye: Readonly<Number3>, center: Readonly<Number3>, up: Readonly<Number3>, target?: Number16): Number16;
    function lookAtWithDirection(eye: Readonly<Number3>, direction: Readonly<Number3>, up: Readonly<Number3>, target?: Number16): Number16;
    function getDirection(viewMatrix: Readonly<Number16>, target?: Number3): [number, number, number] | Uint8Array | Float64Array | {
        0: number;
        1: number;
        2: number;
        length: 3;
    };
    function getRight(viewMatrix: Readonly<Number16>, target?: Number3): [number, number, number] | Uint8Array | Float64Array | {
        0: number;
        1: number;
        2: number;
        length: 3;
    };
    function getUp(viewMatrix: Readonly<Number16>, target?: Number3): [number, number, number] | Uint8Array | Float64Array | {
        0: number;
        1: number;
        2: number;
        length: 3;
    ...
    function getEye(viewMatrix: Readonly<Number16>, target?: Number3): [number, number, number] | Uint8Array | Float64Array | {
        0: number;
        1: number;
        2: number;
        length: 3;
     ...
     */
    function computeOrthographicOffCenter(left: number, right: number, bottom: number, top: number, near: number, far: number, result?: Number16): Number16;
}

 ...
 */
export declare function _getScale(matrix: Readonly<Number16>, target?: Number3): Number3;
/**
 ...
 */
export declare function _setScale(matrix: Readonly<Number16>, scale: Readonly<Number3>, result?: Number16): Uint8Array | Float64Array | {
    0: number;
    1: number;
    2: number;
    3: number;

 ...
 */
export declare function _multiply(left: Readonly<Number16>, right: Readonly<Number16>, target?: Number16): Number16;
/**
 ...
 */
export declare function _multiplyTransformation(left: Readonly<Number16>, right: Readonly<Number16>, target?: Number16): Number16;
/**
...
*/
export declare function _multiplyByMatrix3(matrix: Readonly<Number16>, rotation: Readonly<Number9>, target?: Number16): Number16;
/**
 * Multiplies a transformation matrix (with a bottom row of <code>[0.0, 0.0, 0.0, 1.0]</code>)
 ...
 */
export declare function _multiplyByTranslation(matrix: Readonly<Number16>, translation: Readonly<Number3>, target?: Number16): Number16;
/**
 ...
 */
export declare function _multiplyByUniformScale(matrix: Readonly<Number16>, scale: number, target?: Number16): Uint8Array | Float64Array | {
    0: number;
    1: number;
    2: number;
    3: number;
 ...
 */
export declare function _multiplyByScale(matrix: Readonly<Number16>, scale: Readonly<Number3>, target?: Number16): Uint8Array | Float64Array | {
    0: number;
    1: number;
    2: number;
    3: number;
 ...
 * @returns The modified result parameter.
 */
export declare function _multiplyByVector(matrix: Readonly<Number16>, cartesian: Readonly<Number4>, target?: Number4): Number4;
/**
 ...
 */
export declare function _multiplyByPointAsVector(matrix: Readonly<Number16>, cartesian: Readonly<Number3>, target?: Number3): Number3;
/**
 * Computes the product of a matrix and a {@link Cartesian3}. This is equivalent to calling {@link Matrix4.multiplyByVector}
 ...
 */
export declare function _affineMultiplyByPoint(matrix: Readonly<Number16>, cartesian: Readonly<Number3>, target?: Number3): Number3;
export declare function _multiplyByPoint(matrix: Readonly<Number16>, cartesian: Readonly<Number3>, target?: Number3): Number3;

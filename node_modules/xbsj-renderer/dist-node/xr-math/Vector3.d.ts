...
export declare namespace Vector3 {
     ...
     */
    function cross(left: Readonly<Number3>, right: Readonly<Number3>, target?: Number3): [number, number, number] | Uint8Array | Float64Array | {
        0: number;
        1: number;
        2: number;
        length: 3;
     ...
     */
    function getOrthogonalityVector(constVector: Readonly<Number3>, vectorToFix: Readonly<Number3>, target?: Number3, conormalVector?: Number3): [number, number, number] | Uint8Array | Float64Array | {
        0: number;
        1: number;
        2: number;
        length: 3;
    } | undefined;
    const UNIT_X: Readonly<Number3>;
    const UNIT_Y: Readonly<Number3>;
    const UNIT_Z: Readonly<Number3>;
    const ZERO: Readonly<Number3>;
    const ONE: Readonly<Number3>;
